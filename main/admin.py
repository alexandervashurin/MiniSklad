...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['id', 'title', 'description', 'inventory_number', 'price', 'dt_created', 'dt_updated', 'to_remove']
    list_display_links = ['title', 'description', 'price']


@admin.register(Contractor)
class ContractorAdmin(admin.ModelAdmin):
    list_display = ['id', 'inn', 'title', 'category', 'dt_created', 'dt_updated', 'to_remove']
